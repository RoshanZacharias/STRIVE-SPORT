...
from .models import Product, ProductImage, Variation, Offer
...
def add_variations(request, product_id):
    ...
    if request.method == 'POST':
        ...
        variations = Variation(product=product,variation_category=variation_category, variation_value=variation_value, stock=stock)
        variations.save()
